...
object Instructions {
  ...
  def C_SSPOPCHK         = BitPat("b????????????????0110001010000001")
  def C_SSPUSH           = BitPat("b????????????????0110000010000001")
  ...
  def MACQUIRE           = BitPat("b1010000??????????100000000101011")
  def MAX                = BitPat("b0000101??????????110?????0110011")
  def MAXU               = BitPat("b0000101??????????111?????0110011")
  def MFENCE_PA          = BitPat("b1011111??????????000000001110011") // HasMptCheck
  def MFENCE             = BitPat("b10110000000000000100000000101011")
  def MGETCFG            = BitPat("b010100000000?????000?????0101011")
  def MLA_WHOLE          = BitPat("b100000000000?????00100???0101011")
  def MLA                = BitPat("b0000000??????????00100???0101011")
  def MLAT               = BitPat("b0100000??????????00100???0101011")
  def MLB_WHOLE          = BitPat("b100100000000?????00100???0101011")
  def MLB                = BitPat("b0001000??????????00100???0101011")
  def MLBT               = BitPat("b0101000??????????00100???0101011")
  def MLC_WHOLE          = BitPat("b101000000000?????00100???0101011")
  def MLC                = BitPat("b0010000??????????00100???0101011")
  def MLCT               = BitPat("b0110000??????????00100???0101011")
  def MMACC              = BitPat("b000000000???00???01000???0101011")
  def MIN                = BitPat("b0000101??????????100?????0110011")
  def MINIT              = BitPat("b00000000000000000000000000101011")
  def MINU               = BitPat("b0000101??????????101?????0110011")
  def MINVAL_PA          = BitPat("b0111111??????????000000001110011") // HasMptCheck
  def MRELEASE           = BitPat("b1001000?????00000100000000101011")
  def MRET               = BitPat("b00110000001000000000000001110011")
  def MSA_WHOLE          = BitPat("b100000100000?????00100???0101011")
  def MSA                = BitPat("b0000001??????????00100???0101011")
  def MSAT               = BitPat("b0100001??????????00100???0101011")
  def MSB_WHOLE          = BitPat("b100100100000?????00100???0101011")
  def MSB                = BitPat("b0001001??????????00100???0101011")
  def MSBT               = BitPat("b0101001??????????00100???0101011")
  def MSC_WHOLE          = BitPat("b101000100000?????00100???0101011")
  def MSC                = BitPat("b0010001??????????00100???0101011")
  def MSCT               = BitPat("b0110001??????????00100???0101011")
  def MSETCFG            = BitPat("b010000100000?????00000???0101011")
  def MSETTILEM          = BitPat("b001000100000?????000000000101011")
  def MSETTILEMI         = BitPat("b0010000??????????000000000101011")
  def MSETTILEN          = BitPat("b001100100000?????000000000101011")
  def MSETTILENI         = BitPat("b0011000??????????000000000101011")
  def MSETTILEK          = BitPat("b000100100000?????000000000101011")
  def MSETTILEKI         = BitPat("b0001000??????????000000000101011")
  def MSYNCRESET         = BitPat("b1000000?????00000100000000101011")
  def MUL                = BitPat("b0000001??????????000?????0110011")
  def MULH               = BitPat("b0000001??????????001?????0110011")
  def MULHSU             = BitPat("b0000001??????????010?????0110011")
  def MULHU              = BitPat("b0000001??????????011?????0110011")
  def MULW               = BitPat("b0000001??????????000?????0111011")
  def MZERO              = BitPat("b0000000000000000001100???0101011")
